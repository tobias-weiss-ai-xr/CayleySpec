...
\begin{enumerate}
  \item \textbf{$q$-expansion theory}: The $q$-expansion machinery for modular forms in mathlib would provide an alternative, Fourier-analytic proof of boundedness and unlock further results such as the $q$-expansion principle and Hecke eigenforms.
